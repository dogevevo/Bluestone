...
<head>
    ...
    <meta name="google-site-verification" content="_osXIoQVS7hg5oS_cZMJec2ZP_bgldtRvaPphrfLiVc" />
                                    ...
                                    <div class="col-lg-2 col-md-4 col-4">
                                        <div class="single-gallery-item">
                                            <div class="gallery-img">
                                                <img src="img/gallery/galleryHeader/<?php echo $b ?>.png"
                                                    alt="Gallery Image">
                                                <div class="hover-overlay">
                                                    <a href="img/gallery/galleryHeader/<?php echo $b ?>.png"
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            ...
                            <div class="top-left">
                                ...
                                <span><i class="far fa-envelope"></i><b class="title">Email :</b><a
                                        href="<?php echo $MailRef ?>">
                                        <?php echo $Mail ?>
                                    </a></span>
                                <span><i class="far fa-phone-plus"></i><b class="title">Call :</b><a
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="top-right float-lg-right">
                                <ul class="top-left">
                                    <span><i class="far fa-map-marker-alt"></i><b class="title">Location : </b><a
                ...
                <div class="container-fluid">
                    ...
                    <div class="primary-menu">
                        ...
                        <div class="site-branding">
                            <a href="index.php" class="brand-logo"><img src="img/logo/logo.png" width="150" alt="Site Logo"></a>
