...
.slide-container_r {
    ...
    overflow: hidden;
    background-image: linear-gradient(to top, #0c3483 0%, #303d58 100%, #6b8cce 100%, #a2b6df 100%);
}
...
<div class="slide-container_r">
    <div class="main-carousel" style=" margin-top: 50px ">
        ...
        <div class="cell">
            <video src="img/videos/5.mp4" loop muted controls class=" img "></video>
        </div>

        <!-- <div class="cell">
            <video src="assets/img/videos/6.mp4" loop muted controls class=" img "></video>
        </div> -->
        ...
    </div>
</div>
