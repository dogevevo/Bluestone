<?php include('php/secction/header.php') ?>
        ...
        <section class="page-title-area text-white bg_cover" style="background-image: url(img/bg/13.jpeg);">
            <div class="container">
                <!--======  Page-title-Inner ======-->
        ...
        <section class="features-section pt-95">
                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-md-12">
                        <div class="features-content-box p-r z-2 mb-20">
                            ...
                            <div class="section-title mb-50 wow fadeInDown">
                                <span class="sub-title"><img width="60" src="img/icons/T1.svg" alt=""></i>What We Do For Home</span>
                    ...
                    <div class="col-xl-6 col-lg-12">
                        <div class="features-two_image-box p-r z-1 text-center pr-lg-60 mb-50 wow fadeInRight">
                            <img src="img/gallery/galleris/vertical/20.jpg" class="mt-50" alt="features image">
                            <div class="shape shape-one"><span></span></div>
                            <div class="circle-logo" style="right: -15px;">
         ...
         <!-- Me veo en la necesidad de comentar este codigo 
            seccion servicios  -->
        <section class="service-bgc-section p-r z-1 main-bg pt-150 pb-70" style="background-color: #008B8B; ">
